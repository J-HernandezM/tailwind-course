...
flights.forEach( flight => {
    const structure = `
        <div class="shadow-sm shrink-0 w-40 h-48 rounded-lg text-white md:w-72 md:h-80 bg-secondary transform transition-all hover:-translate-y-4 hover:shadow-xl">
